...
const settingsSections: SettingsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'change-password', label: 'تغيير كلمة المرور', icon: Shield, color: '#E60000' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'advanced-security', label: 'الأمان المتقدم', icon: ShieldCheck, color: '#E60000' },
            ...
            <div className="flex gap-2 px-4 pb-3">
              {[
                ...
                <button
                  ...
                  style={{
                    background: language === lang.key ? 'rgba(230,0,0,0.1)' : isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)',
            ...
            <div className="flex gap-2 px-4 pb-3">
              {(['YER', 'SAR', 'USD'] as const).map((cur) => (
                <button
                  ...
                  style={{
                    background: currency === cur ? 'rgba(230,0,0,0.1)' : isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)',
        ...
        <div className="px-5 pb-8 space-y-2">
          {(['small', 'medium', 'large'] as const).map((size) => (
            <button
              ...
              style={{
                background: fontSize === size ? 'rgba(230,0,0,0.08)' : isDark ? '#1A1A1A' : '#FFFFFF',
                border: fontSize === size ? '1.5px solid #E60000' : `1px solid ${isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.05)'}`,
              }}
            >
              <div className="flex-1 text-right">
                <span className="text-sm font-medium" style={{ color: fontSize === size ? '#E60000' : isDark ? '#DDD' : '#444' }}>{labels[size]}</span>
              </div>
              {fontSize === size && <Check size={18} strokeWidth={2} color="#E60000" />}
            </button>
          ))}
        </div>
      </motion.div>
        ...
        {toastMsg && (
          ...
          >
            <div className="px-4 py-3 rounded-2xl flex items-center gap-2 shadow-lg" style={{
              background: toastMsg.type === 'success' ? 'rgba(16,185,129,0.95)' : 'rgba(230,0,0,0.95)',
              color: '#FFF',
            }}>
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {isBiometricItem && biometricStatus && (
                              <span className="text-[10px] block text-right" style={{ color: biometricStatus.available ? '#10B981' : '#E60000' }}>
