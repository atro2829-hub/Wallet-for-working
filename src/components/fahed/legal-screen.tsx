...
const faqItems: FaqItem[] = [
  {
    question: 'كيف أنشئ حساب في الحبيلين اونلاين؟',
  ...
  },
  {
    ...
    answer: 'تدعم محفظة الحبيلين اونلاين ثلاث عملات رئيسية: الريال اليمني (YER) وهو العملة المحلية الأساسية، الريال السعودي (SAR) لسهولة التعامل مع السوق السعودي، والدولار الأمريكي (USD) للمعاملات الدولية والاستثمار في العملات الرقمية. يمكنك الاحتفاظ بأرصدة منفصلة لكل عملة، وكذلك التبديل بين العملات من خلال خدمة تبادل العملات المدمجة في التطبيق بأسعار صرف تنافسية ومحدّثة يومياً. كما يمكنك استخدام الدولار الأمريكي للاستثمار في خطط USDT المختلفة.',
  },
  {
  ...
  },
  {
    ...
    answer: 'قسم الاستثمار في الحبيلين اونلاين يتيح لك الاستثمار في عملة USDT (تيثر) بخطط متنوعة تناسب جميع المستثمرين. يمكنك الاختيار بين خطة يومية بعائد 0.5% وخطة أسبوعية بعائد 0.8% وخطة شهرية بعائد 1.2% وخطة ربع سنوية بعائد 1.5%. كل خطة يختلف معدل العائد والحد الأدنى للاستثمار. للبدء، انتقل إلى قسم استثمار الكريبتو من الصفحة الرئيسية، اختر الخطة المناسبة، وحدد مبلغ الاستثمار بالدولار الأمريكي. يجب أن يكون حسابك موثقاً للاستثمار. يمكنك متابعة أرباحك في أي وقت.',
  },
  {
...
const privacySections = [
  {
    title: 'مقدمة',
    icon: '📄',
    content: `مرحباً بك في محفظة الحبيلين اونلاين. نحن نلتزم بحماية خصوصيتك وبياناتك الشخصية. تسري سياسة الخصوصية هذه على جميع خدمات التطبيق وموقعه الإلكتروني. باستخدامك لتطبيق الحبيلين اونلاين، فإنك توافق على الممارسات الموضحة في هذه السياسة.
...
يرجى قراءة هذه السياسة بعناية لفهم كيفية تعاملنا مع معلوماتك. إذا كنت لا توافق على أي جزء من هذه السياسة، يرجى عدم استخدام التطبيق.`,
  },
  {
    ...
    icon: '📋',
    content: `تجمع محفظة الحبيلين اونلاين البيانات الضرورية فقط لتقديم خدماتها بشكل فعال وآمن. تشمل البيانات التي نجمعها:
...
في جميع الحالات، نضمن أن أي طرف ثالث يلتزم بمعايير حماية البيانات نفسها التي نطبقها أو بمعايير أعلى. نحن لا نبيع أو نتاجر أو نتشارك ببياناتك الشخصية تحت أي ظرف من الظروف.`,
  },
  {
    title: 'حقوق المستخدم',
    icon: '⚖️',
    content: `يحق لك كمستخدم لمحفظة الحبيلين اونلاين ممارسة الحقوق التالية:
...
لتمارس أي من هذه الحقوق، يمكنك التواصل مع فريق الدعم من داخل التطبيق أو عبر البريد الإلكتروني الرسمي. سنقوم بالاستجابة لطلبك خلال 30 يوماً كحد أقصى.`,
  },
  {
    ...
    icon: '🍪',
    content: `تستخدم محفظة الحبيلين اونلاين ملفات تعريف الارتباط والتقنيات المماثلة لتحسين تجربة المستخدم. تشمل هذه الملفات:
            ...
            >
              ...
              >
                ...
                <p className="text-xs leading-relaxed" style={{ color: isDark ? '#AAA' : '#666' }}>
                  إليك أكثر الأسئلة شيوعاً حول محفظة الحبيلين اونلاين. إذا لم تجد إجابتك، يمكنك التواصل مع فريق الدعم الفني.
                </p>
              </motion.div>
          ...
          {activeTab === 'privacy' && (
            ...
            >
              ...
              >
                ...
                <p className="text-xs leading-relaxed" style={{ color: isDark ? '#AAA' : '#666' }}>
                  نحن في محفظة الحبيلين اونلاين نلتزم بحماية خصوصيتك وبياناتك الشخصية. توضح سياسة الخصوصية هذه كيفية جمع واستخدام وحماية معلوماتك عند استخدامك لتطبيقنا. يرجى قراءتها بعناية لفهم حقوقك والتزاماتنا.
                </p>
              </motion.div>
          ...
          {activeTab === 'about' && (
            ...
            >
              ...
              >
                ...
                <p className="text-sm mt-1" style={{ color: isDark ? '#888' : '#AAA' }} dir="ltr">Al-Habaylain Online</p>
                <div
              ...
              >
                ...
                <p className="text-xs leading-relaxed" style={{ color: isDark ? '#AAA' : '#666' }}>
                  محفظة الحبيلين اونلاين (Al-Habaylain Online) - الإصدار 1.0.0. جميع الحقوق محفوظة © 2026. هذا التطبيق مرخص للاستخدام الشخصي وغير التجاري فقط. يحظر نسخ أو تعديل أو توزيع أي جزء من التطبيق دون إذن كتابي مسبق من مطور التطبيق. التطبيق محمي بموجب قوانين حقوق الملكية الفكرية المعمول بها في الجمهورية اليمنية.
                </p>
              </motion.div>
            </motion.div>
          )}
