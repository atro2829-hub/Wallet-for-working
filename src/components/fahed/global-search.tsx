      ...
      groups.push({
        ...
        results: matchedProviders.map((p) => ({
          ...
          action: () => {
            ...
            const billIds = ['elec-sanaa', 'elec-aden', 'water-sanaa', 'water-aden'];
            const govIds = ['civil-registry', 'passport', 'traffic', 'municipal'];

            if (telecomIds.includes(p.id)) {
              setActiveScreen('recharge');
            } else if (billIds.includes(p.id)) {
              setActiveScreen('bills');
            } else if (govIds.includes(p.id)) {
              setActiveScreen('government-payment');
            } else {
